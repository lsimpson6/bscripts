...
const states = {
    ...
    3: {state:"Florida", title:"Florida", served:"2,768", programs:"6", locations:"3", expenditures:"2,927,738"},
    ...
    15: {state:"South Carolina", title:"South Carolina", served:"500", programs:"5", locations:"1", expenditures:"807,940"},
    16: {state:"South Dakota", title:"South Dakota", served:"79", programs:"2", locations:"1", expenditures:"359,409"},
...
const globalObj = {
    0: {name:"United States", title:"United States", served: (usaTotal().served + 509), programs: usaTotal().programs, locations: usaTotal().locations, expenditures: usaTotal().expenditures},
...
function menu(){
    ...
    if(status == "open"){
        ...
        document.getElementById('custom-header').setAttribute('data-dark','false');
    }
}
